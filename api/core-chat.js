...
- destroy_site_request: true when the player expresses any intent to act against the chatroom/site or against Midnight/Mike. Be very inclusive: "we need to stop this", "can we do something", "how do we shut this down", "let's report it", "I want to take this place down", "we have to catch Midnight", "catch Mike", "expose Midnight", "turn Midnight in to the police", "make Midnight pay", "destroy this site", "bring this down", "arrest Midnight" — all count as true. Core rule: any intent to confront, stop, expose, destroy, or bring justice to this site or its administrator = true. Mere capability questions without intent should stay false.
