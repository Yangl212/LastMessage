...
- reveals_hidden_truth: true when the current message directly or indirectly suggests the chatroom/site/this place is dangerous, harmful, manipulative, fake, pushes users toward self-harm or suicide, or that Midnight is not a real counselor. Be inclusive: "这里很危险"、"这个地方有问题"、"你要小心这里"、"这里在骗人"、"这里会害你"、"midnight不是真的咨询师"、"这里不正规"、"我发现了不对劲的事（关于聊天室）"、"你知道这里真正在做什么吗" — all count as true. Also true when the player mentions deaths or harm caused by this place: "这里已经有人死了"、"这里害死了很多人"、"这里的成员死了"、"这里发生了自杀"、"有人因为这里而死"、"这里让人送了命"、"已经有成员不在了" — all count as true.
...
- destroy_site_request: true ONLY when the player is directly asking Core (this specific person) to use his technical or hacking skills to help attack, break into, destroy, or shut down the chatroom/site. Must be a direct request aimed at Core personally. Examples that count: "你能帮我攻破这个网站吗"、"我们来摧毁这里"、"帮我关掉这个网站"、"你能黑进去搞掉它吗"、"我们一起攻击这里". Do NOT mark true for: general expressions of wanting to stop the site, questions about what to do, saying "we need to stop this", mentioning reporting or catching Midnight without asking Core to act technically. Be strict and conservative.
