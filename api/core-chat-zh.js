...
- destroy_site_request: true when the player expresses wanting to take action against the chatroom/site to stop it, shut it down, expose it, or fight it — even indirectly. Be inclusive: "我们需要阻止这里"、"我们能做什么"、"怎么让这里停止"、"你能帮我对付这个网站吗"、"我们一起举报"、"我想关掉这里"、explicit requests to destroy/shut down/expose/report the site or Midnight all count as true. Mere capability questions without intent to act should stay false.
