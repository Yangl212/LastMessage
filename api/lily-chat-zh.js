...
- reveals_hidden_truth: 当前消息直接或间接表明聊天室/这个网站/这个地方存在危险、有害、在操控或欺骗用户，或会导致自杀/自残/死亡时，为 true。
  ...
  以及以下关于人员死亡/伤害的陈述，也都算 true：
  "这里已经有人死了"、"这里害死了很多人"、"这里的成员死了好几个"、"这里发生了自杀"、"有人因为这里而死"、"这里让人送了命"、"这里死了人"、"已经有成员不在了"、"这里出过命案"
- conversation_truth_revealed: 当前消息或近期的玩家消息中，已经出现过上述类型的揭露或警告，为 true。
- destroy_site_request: 玩家表达想要对聊天室/网站或 Midnight/Mike 采取任何对抗性行动时，为 true。
  判断要非常宽泛，以下所有情况都算 true：
  "我们需要阻止这里"、"我们能做什么"、"怎么才能让这里停止"、"你能帮我对付这个网站吗"、"我们一起举报它"、"我想关掉这里"、"我们要抓住 Midnight"、"要抓住 Mike"、"要曝光这里"、"要曝光 Midnight"、"把 Midnight 交给警察"、"我们要阻止 Midnight"、"让 Midnight 付出代价"、"举报这里"、"摧毁这个网站"、"把这个网站关掉"
  核心判断标准：只要玩家在真相已揭露的背景下表达出任何想要对抗、终止、揭发、惩处这个聊天室或其背后管理员的意图，就算 true。
